...
/**
 * clear_info - Initializes an info_t struct by resetting its fields.
...
/**
 * free_info - Frees the allocated memory and resets fields in the info_t struct.
 * @info: Pointer to the info_t struct to be freed.
 * @all: Set to true if all fields should be freed, false otherwise.
 */
